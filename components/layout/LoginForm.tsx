      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          <Button
            ...
            size="icon"
            onClick={handleClose}
            className="absolute top-4 right-4 z-10 h-9 w-9 shrink-0 rounded-full shadow-md"
                ...
                <>
                  ...
                  <form onSubmit={handleForgotSubmit} className="space-y-5">
                    ...
                    <Button
                      ...
                      className="w-full py-3 rounded-xl text-sm font-semibold shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                  ...
                  {authMode === 'signin' && (
                    <div className="space-y-5">
                      ...
                      <Button
                        ...
                        disabled={loading}
                        className="w-full py-3 rounded-xl text-sm font-semibold shadow-md mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                  ...
                  {authMode === 'signup' && (
                    <div className="space-y-5">
                      ...
                      <Button
                        ...
                        disabled={loading}
                        className="w-full py-3 rounded-xl text-sm font-semibold shadow-md mt-5 transition-transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
